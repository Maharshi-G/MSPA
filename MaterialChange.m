...
rh = 1.1;                 % Ridge height
rw = linspace(3.0,3.1,10);% Ridge half-width
...
subplot(4,5,i);
contourmode(x,y,Hx);
title('Hx (TE mode)','interpreter','latex'); xlabel('x'); ylabel('y');grid on; 
for v = edges, line(v{:}); end

subplot(4,5,i+10)
contourmode(x,y,Hy);
title('Hy (TE Mode)','interpreter','latex'); xlabel('x'); ylabel('y'); grid on; 
for v = edges, line(v{:}); end
end
% subplot(122);
% contourmode(x,y,Hy);
